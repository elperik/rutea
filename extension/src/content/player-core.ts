// Núcleo del player: ejecuta un paso sobre el DOM y verifica su postcondición.
// No depende de las APIs de `chrome`, por lo que es testeable con un DOM real
// (happy-dom). El adaptador `player.ts` lo conecta con la mensajería.
...
export async function executeStep(step: Step, value: unknown): Promise<Outcome> {
